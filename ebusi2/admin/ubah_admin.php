...
?>
           ...
           <div class="col-xl-12 col-lg-7">
             <div class="card shadow mb-4 mt-3">
               ...
               <div class="card-body">
                 <form method="post">
                  <h5 class="m-0 font-weight-bold text-primary">Ubah Data Admin</h5><hr>
                 ...
                 <form method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-row">
                   <div class="form-group col-md-5">
                    <center><label style="background-color: rgb(135 206 250); ">Foto Admin</label></center><br>
                   ...
                   <hr>
                    <a  href="index.php?halaman=data_admin" class="btn btn-warning"> <span class="glyphicon glyphicon-plus" aria-hidden="true"> <i class="fas fa-hand-point-left"></i></span></a> 
