...
<div class="col-xl-12 col-lg-7">
             <div class="card shadow mb-4 mt-3">
               ...
               <div class="card-body">
                 <form method="post">
                  <h5 class="m-0 font-weight-bold text-primary">Data Admin</h5><hr>

                  <a  href="index.php?halaman=tambah_admin" class="btn btn-primary"><i class="fas fa-plus-circle"></i> Tambah Admin</a> <a href="print-admin.php" target="_blank" class="btn btn-primary"><i class="fas fa-print"></i></a> <br><br>
