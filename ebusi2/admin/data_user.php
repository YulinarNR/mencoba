           ...
           <div class="col-xl-12 col-lg-7">
             <div class="card shadow mb-4 mt-3">
               ...
               <div class="card-body">
                 <form method="post">
                  <h5 class="m-0 font-weight-bold text-primary">Data User</h5><hr>

                  <a  href="index.php?halaman=tambah_user" class="btn btn-primary"><i class="fas fa-plus-circle"></i> Tambah Data</a> <a href="print-user.php" target="_blank" class="btn btn-primary"><i class="fas fa-print"></i></a> <br><br>
