             ...
             <div class="card shadow mb-4 mt-3">
               ...
               <div class="card-body">
                 <form method="post">
                  ...
                  <a  href="index.php?halaman=tambah_produk" class="btn btn-primary pull-right"><i class="fas fa-plus-circle"></i> Tambah Data</a> <a href="print-produk.php" target="_blank" class="btn btn-primary "><i class="fas fa-print"></i></a><br /><br />
