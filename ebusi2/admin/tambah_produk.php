...
if (isset($_POST['save'])) {
  ...
  $koneksi -> query("INSERT INTO tb_produk (nama_produk,kategori,stok,beratisi_produk,harga_produk,foto_produk,info_produk,nutrisi_manfaat,cara_penyimpanan)VALUES('$_POST[nama_produk]','$_POST[kategori]','$_POST[stok]','$_POST[beratisi_produk]','$_POST[harga_produk]','$nama','$_POST[info_produk]','$_POST[nutrisi_manfaat]','$_POST[cara_penyimpanan]')");
