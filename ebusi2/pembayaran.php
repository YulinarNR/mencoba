             ...
             <div class="card shadow mb-4 mt-3">
              ...
              <!-- <pre><?php // print_r($_SESSION)?></pre> -->
               ...
               <div class="card-body">
                  ...
                  <h5 class="m-0 font-weight-bold text-primary">Konfirmasi Pembayaran</h5><br>
                  <p>Kirim bukti pembayaran disini</p>
                  <div class="alert alert-info">Total Tagihan anda <strong>Rp. <?php echo number_format($det_pbl['total_pembelian']); ?>,-</strong></div>
