                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <?php if ($row['status_pembelian']=="pending"): ?>
                            ...
                            <a href="batalkan_pembelian.php?id=<?php echo $row['id_pembelian']; ?>" class="btn btn-danger">Batalkan</a><br>
                            ...
                            <!-- <?php   
                            // $dataproduk = mysqli_query($koneksi, "SELECT * FROM tb_produk WHERE id_produk = ''");
                            // $barisproduk = mysqli_fetch_array($dataproduk);
                            // $id_produk = $barisproduk['id_produk'];

                            // $stoklamaproduk = $barisproduk['stok'];
                            // $jumlahproduk = $row['jumlah']; //jumlah produk yang dibeli, ngambil dari inner join
                            // $stokbaru = $stoklamaproduk + $jumlahproduk; //stok kembali ketika dibatalkan

                            // $koneksi->query("UPDATE tb_produk SET stok = $stokbaru WHERE id_produk = $id_produk"); 
                             ?> -->
                             <!-- <pre><?php// print_r($row) ?></pre> -->
                            <!-- <pre><?php// print_r($barisproduk) ?></pre>  -->
                             <!-- <pre><?php// print_r($stokbaru) ?></pre>  -->
