              ...
              <hr>
                  ...
                  <p><center><strong><?php echo $row['nama_produk'];?></strong><br>
                     ...
                     <form action="" method="post">
                        ...
                        <a class="btn btn-primary" data-toggle="modal" data-target="#myModaldetail" role="button">
                       ...
                       <a href="https://wa.me/6285211156867" class="waves-effect waves-light btn green white-text tooltipped" data-position="bottom" data-delay="50" data-tooltip="Lihat Detail">
                           <button class="btn btn-warning text-white"><i class="fas fa-cart-plus"></i></button>
                        </a>
                        </center>
