...
//pengaturan
// $data = mysqli_query($koneksi, "SELECT * FROM tb_pengaturan");
       ...
       <div class="row">
        <div class="col-lg-6 pt-2 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <ul>
            ...
            <li><i class="ri-check-line"></i> Mudah</li>
            <li><i class="ri-check-line"></i> Efektif</li>
          </ul>
          <div class="mt-3">
        ...
        <div class="col-lg-6 order-1 order-lg-2 hero-img">
          <img src="assets/img/page3.jpg" class="img-fluid" alt="">
        </div>
      </div>
    </div>
                  ...
                  <p><center><strong><?php echo $row['nama_produk'];?></strong><br>
                     ...
                     <form action="" method="get">
                      <center> 
                        ...
                        <!-- <a class="btn btn-primary text-white" data-toggle="modal" data-target="#Modal-detail" role="button"> -->
...
<footer id="footer">   <!-- footer -->
  ...
  <script type="text/javascript">
    (function () {
    var options = {
    whatsapp: "+6281335703958", // WhatsApp number
