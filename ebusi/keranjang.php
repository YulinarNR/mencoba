  ...
  if ($_SESSION['keranjang']== "") {
   echo "<script>alert('Silahkan tambahkan produk terlebih dahulu');</script>";
   header('location:index.php#team');
   echo "<script>location=index.php#team</script>";
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-12 justify-content-center">
         ...
         <br>
          <div class="mt-3">
             <a href="index.php#team" class="btn-get-quote">Lanjutkan Belanja</a>
