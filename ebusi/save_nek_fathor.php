                 ...
                 <form method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-row">
                   ...
                   <div class="form-group col-md-7">
                     <table class="table">
                    <tr>
                      <td><h4><b><?php echo $row['nama_produk'];?></b></h4></td>
                    </tr>

                    <tr>
                      <td style="text-align: justify;"><?php echo $row['info_produk'];?></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      while ($d = mysqli_fetch_assoc($sql)) {
                       ...
                       ?>
                       <td><button class="btn btn-primary btn-sm" value="<?= $d['id_pilihan'];?>" name="pilihan" id="btn<?= $no++ ?>"><?= $d['nama_pilihan'];?> <?= $d['berat'];?></button></td>
                     <?php } ?>
                    </tr>
