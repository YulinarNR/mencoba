              ...
              <div class="form-group col-md-8">
                <table class="table">
                   <tr>
                    ...
                    <tr>
                      <td>Jumlah</td>
                      <td><input type="number" name="jml_pembelian" class="form-control form-control-sm" value="1" min="1" max="<?= $row['stok'];?>"></td>
                    </tr>


                    <tr>
                      <td><a href="cart.php?id=<?php echo $row['id_produk']?> &action=add">OrderNow</a></td>
                    </tr>
