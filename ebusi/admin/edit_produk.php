...
$kategrori_prod = array('Buah','Sayur');
?>
           <!-- Area Chart -->
               ...
               <div class="card-body">
                 <form method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-row">
                   ...
                   <div class="form-group col-md-4">
                    <label>Tambahkan Diskon</label>
                     <input type="number" class="form-control form-control-user" name="diskon" value="<?php echo $row['diskon'];?>" >
                   </div>
                   </div>  <!-- Ahir Form Row -->
              ...
              if (isset($_POST['ubah'])) {
                ...
                if (!empty($lokasifoto)) {
                  move_uploaded_file($lokasifoto, "../foto_produk/$namafoto");
                   ...
                   $koneksi -> query("UPDATE tb_produk SET nama_produk='$_POST[nama_produk]',kategori='$_POST[kategori]',stok='$_POST[stok]',beratisi_produk='$_POST[beratisi_produk]',harga_produk='$_POST[harga_produk]',diskon='$_POST[diskon]',foto_produk='$namafoto',info_produk='$_POST[info_produk]',nutrisi_manfaat='$_POST[nutrisi_manfaat]',cara_penyimpanan='$_POST[cara_penyimpanan]' WHERE id_produk='$_GET[id]'");


                } else{
                   $koneksi -> query("UPDATE tb_produk SET nama_produk='$_POST[nama_produk]',kategori='$_POST[kategori]',stok='$_POST[stok]',beratisi_produk='$_POST[beratisi_produk]',harga_produk='$_POST[harga_produk]',diskon='$_POST[diskon]',info_produk='$_POST[info_produk]',nutrisi_manfaat='$_POST[nutrisi_manfaat]',cara_penyimpanan='$_POST[cara_penyimpanan]' WHERE id_produk='$_GET[id]'");
