             ...
             <div class="card shadow mb-4 mt-3">
               ...
               <div class="card-body">
                 <form method="post">
                  ...
                  <a  href="index.php?halaman=tambah_produk" class="btn btn-primary"><i class="fas fa-plus-circle"></i> Tambah Data</a> <a href="#" class="btn btn-primary"><i class="fas fa-print"></i></a><br /><br />
                        ...
                        while($row = mysqli_fetch_array($data)){ ?>
                          ...
                          <tr align="center">
                            <td><?php echo $no++; ?></td>
                             ...
                             <td><img src="../foto_produk/<?php echo $row['foto_produk']; ?>" height='30px' width='30px'></td></td>
                             
                             <td>
                              <a href="index.php?halaman=detail_produk_admin&id=<?php echo $row['id_produk']; ?>" class="btn btn-primary"><i class="fas fa-info-circle"></i></a>
