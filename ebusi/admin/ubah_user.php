...
?>
           ...
           <div class="col-xl-12 col-lg-7">
             <div class="card shadow mb-4 mt-3">
               ...
               <div class="card-body">
                 <form method="post">
                  <h5 class="m-0 font-weight-bold text-primary">Ubah Data User</h5><hr>
                 ...
                 <form method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-row">
                   <div class="form-group col-md-5">
                    <center><label style="background-color: rgb(135 206 250); ">Foto User</label></center><br>
                   ...
                   <div class="form-group col-md-7">
                    ...
                    <tr>
                      ...
                      <td><input type="number" class="form-control form-control-user" name="info_kontak" value="<?php echo $row['info_kontak'];?>" required></td>
                       <td><input type="number" class="form-control form-control-user" name="password" value="<?php echo $row['password'];?>" required></td>
                    </tr>
                   ...
                   <hr>
                    <a  href="index.php?halaman=data_user" class="btn btn-warning"> <span class="glyphicon glyphicon-plus" aria-hidden="true"> <i class="fas fa-hand-point-left"></i></span></a> 
                     <button type="submit" class="btn btn-primary" name="ubah"><i class="fas fa-save"></i> Simpan Perubahan</button>
        ...
        <!-- Aksi Edit -->
              ...
              if (isset($_POST['ubah'])) {
                ...
                if (!empty($lokasifoto)) {
                  move_uploaded_file($lokasifoto, "gambar/foto_user/$namafoto");

                   $koneksi -> query("UPDATE tb_user SET email='$_POST[email]',username='$_POST[username]',password='$_POST[password]',nama_depan='$_POST[nama_depan]',nama_belakang='$_POST[nama_belakang]',alamat='$_POST[alamat]',info_kontak='$_POST[info_kontak]',foto_user='$namafoto',tgl_buat='$tanggal',id_level='2' WHERE id_user='$_GET[id]'");
