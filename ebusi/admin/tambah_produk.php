                  ...
                  <div class="form-row">
                   ...
                   <div class="form-group col-md-4">
                    <label>Berat atau Isi Produk</label>
                     <input type="text" class="form-control form-control-user" name="beratisi_produk" required>
                   </div>
                   ...
                   <div class="form-group col-md-4">
                    <label>Tambahkan Diskon</label>
                     <input type="number" class="form-control form-control-user" name="diskon" >
                   </div>
                   </div>  <!-- Ahir Form Row -->
...
if (isset($_POST['save'])) {
  ...
  $koneksi -> query("INSERT INTO tb_produk (nama_produk,kategori,stok,beratisi_produk,harga_produk,diskon,foto_produk,info_produk,nutrisi_manfaat,cara_penyimpanan)VALUES('$_POST[nama_produk]','$_POST[kategori]','$_POST[stok]','$_POST[beratisi_produk]','$_POST[harga_produk]','$_POST[diskon]','$nama','$_POST[info_produk]','$_POST[nutrisi_manfaat]','$_POST[cara_penyimpanan]')");
