             ...
             <div class="card shadow mb-4 mt-3">
               ...
               <div class="card-body">
                 <form method="post">
                  ...
                  <a  href="index.php?halaman=tambah_user" class="btn btn-primary"><i class="fas fa-plus-circle"></i> Tambah Data</a> <a href="#" class="btn btn-primary"><i class="fas fa-print"></i></a> <br><br>
