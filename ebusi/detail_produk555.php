             ...
             <div class="card shadow mb-4 mt-3">
               ...
               <div class="card-body">
                 <form method="post">
                  ...
                  <a  href="index.php#team" class="btn btn-warning"> <span class="glyphicon glyphicon-plus" aria-hidden="true"> <i class="fas fa-hand-point-left"></i></span></a> <br /><br />
                   ...
                   <div class="form-group col-md-7">
                    ...
                    <tr>
                      <td>Jumlah Pembelian</td>
                        <td><input class="form-control form-control-sm" type="number" name="jumlah" value="1" min="1" max="<?= $row['stok']; ?>"></td> 
                    </tr>
                    <tr>
